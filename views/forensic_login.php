  ...
  width:60%;
    ...
    <div class="wrapper fadeInDown">
        <div id="formContent">
          ...
          <img class="img-fluid" src="/assets/images/edwinclark.png" alt="">
          </div>

          <div class="fadeIn first">
            <h2>PORTAL FORENSIC SYSTEM</h2>
          </div>
          ...
          <form>
            ...
            <input type="button" onclick="submitForm()" class="fadeIn fourth" value="Download data">
          </form>
     ...
     console.log(res);
         ...
         if (res.status == true) {
             ...
             setTimeout(()=> {
               ...
               setTimeout(()=> {
                     window.location.href = `/forensic/log`;
                 }, 1500);                       
         }  else {
               $.toast({
                     text: `<h6>${res.message}</h6>`,
